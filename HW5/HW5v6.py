"""
Description: This program uses three functions to find a persons full name, their
phone number, and their ssn. It then puts all information into an organized output
where it will repeat the questions until it is stopped.
"""
...
def isValidSSN(tmpSSN):
    if len(tmpSSN) == 11 and tmpSSN[3] == '-' and tmpSSN[6] == '-' and tmpSSN[0:3].isdigit() and \
